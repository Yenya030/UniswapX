...
contract V2DutchOrderOutputOverrideBugTest is Test, DeployPermit2, PermitSignature {
    ...
    function testOutputOverrideIgnored() public {
        ...
        V2DutchOrder memory order = V2DutchOrder({
            ...
            baseOutputs: OutputsBuilder.singleDutch(address(tokenOut), baseOutput, baseOutput, swapper),
        ...
        // The override amount should be honored
